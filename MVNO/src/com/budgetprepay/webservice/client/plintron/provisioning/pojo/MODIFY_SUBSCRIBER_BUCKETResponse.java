...
public class MODIFY_SUBSCRIBER_BUCKETResponse {
	...
	public static MODIFY_SUBSCRIBER_BUCKETResponse parse(final String xml) throws Exception {
		MODIFY_SUBSCRIBER_BUCKETResponse response = new MODIFY_SUBSCRIBER_BUCKETResponse();
