...
public class LERGDAllocateMSISDNResponse {
	...
	public static LERGDAllocateMSISDNResponse parse(final String xml) throws Exception {
		LERGDAllocateMSISDNResponse response = new LERGDAllocateMSISDNResponse();
