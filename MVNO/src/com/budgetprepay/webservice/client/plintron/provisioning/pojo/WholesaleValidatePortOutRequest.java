...
public class WholesaleValidatePortOutRequest {

	private static String ACTION = "/PORTOUT/ACTIVITY/VALIDATE";
	...
	public String toString() {
		...
		buffer.append("</HEADER>");
		buffer.append("<BODY>");
		buffer.append("<MSG_TYPE>VALIDATE</MSG_TYPE>");
	    ...
	    buffer.append("<PortOutValidationRequest>");
	    buffer.append("<WholesalePartnerPortoutValidationInput>");
