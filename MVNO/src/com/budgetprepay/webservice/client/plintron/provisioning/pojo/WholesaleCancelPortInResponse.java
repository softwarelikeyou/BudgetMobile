...
public class WholesaleCancelPortInResponse {
	...
	public static WholesaleCancelPortInResponse parse(final String xml) throws Exception {
		WholesaleCancelPortInResponse response = new WholesaleCancelPortInResponse();
