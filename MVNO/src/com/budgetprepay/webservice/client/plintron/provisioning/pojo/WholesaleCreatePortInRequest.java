...
public class WholesaleCreatePortInRequest {

	private static String ACTION = "/PORTIN/ACTIVITY/CREATE";
	
	public static String SERVICE_NAME = "CreatePortInRequest";
	...
	public String toString() {
		...
		buffer.append("</HEADER>");
		buffer.append("<BODY>");
		buffer.append("<MSG_TYPE>Create-Port-In</MSG_TYPE>");
	    ...
	    buffer.append("<WholesaleCreatePortInRequest>");
	    buffer.append("<WholesaleCreatePortInInput>");
