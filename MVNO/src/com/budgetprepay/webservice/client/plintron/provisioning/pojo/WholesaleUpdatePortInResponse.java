...
public class WholesaleUpdatePortInResponse {
	...
	public static WholesaleUpdatePortInResponse parse(final String xml) throws Exception {
		WholesaleUpdatePortInResponse response = new WholesaleUpdatePortInResponse();
