...
public class MODIFY_SUBSCRIBER_STATUSResponse {
	...
	public static MODIFY_SUBSCRIBER_STATUSResponse parse(final String xml) throws Exception {
		MODIFY_SUBSCRIBER_STATUSResponse response = new MODIFY_SUBSCRIBER_STATUSResponse();
