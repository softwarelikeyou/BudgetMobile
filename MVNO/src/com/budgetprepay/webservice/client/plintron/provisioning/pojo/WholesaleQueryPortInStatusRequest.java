...
public class WholesaleQueryPortInStatusRequest {

	private static String ACTION = "/PORTIN/STATUS/GET";
	
	public static String SERVICE_NAME = "QueryPortInStatus";
	...
	public String toString() {
		...
		buffer.append("</HEADER>");
		buffer.append("<BODY>");
		buffer.append("<MSG_TYPE>Query-Port-In</MSG_TYPE>");
		//buffer.append("</PRIMARY_IMSI>");
    	...
    	buffer.append("<soapenv:Envelope xmlns:soapenv=\"http://schemas.xmlsoap.org/soap/envelope/\">");
   	    ...
   	    buffer.append("<WholesaleQueryPortInStatusRequest>");
   	    buffer.append("<WholesaleQueryPortInStatusInput>");
