...
public class WholesaleQueryPortInStatusResponse {
	...
	public static WholesaleQueryPortInStatusResponse parse(final String xml) throws Exception {
		WholesaleQueryPortInStatusResponse response = new WholesaleQueryPortInStatusResponse();
