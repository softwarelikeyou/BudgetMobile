...
public class WholesaleValidatePortOutResponse {
	...
	public static WholesaleValidatePortOutResponse parse(final String xml) throws Exception {
		WholesaleValidatePortOutResponse response = new WholesaleValidatePortOutResponse();
