...
public class CHANGE_MSISDNResponse {
	...
	public static CHANGE_MSISDNResponse parse(final String xml) throws Exception {
		CHANGE_MSISDNResponse response = new CHANGE_MSISDNResponse();
