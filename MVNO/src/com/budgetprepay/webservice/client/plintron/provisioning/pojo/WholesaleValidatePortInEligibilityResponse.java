...
public class WholesaleValidatePortInEligibilityResponse {
	...
	public static WholesaleValidatePortInEligibilityResponse parse(final String xml) throws Exception {
		WholesaleValidatePortInEligibilityResponse response = new WholesaleValidatePortInEligibilityResponse();
