...
public class ServiceDeactivateResponse {
	...
	public static ServiceDeactivateResponse parse(final String xml) throws Exception {
		ServiceDeactivateResponse response = new ServiceDeactivateResponse();
