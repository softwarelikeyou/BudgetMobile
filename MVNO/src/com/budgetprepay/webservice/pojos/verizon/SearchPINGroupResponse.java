...
/**
 * <p>Java class for SearchPINGroupResponse complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="SearchPINGroupResponse">
 *   &lt;complexContent>
 ...
 *         &lt;element name="batchSummary" type="{http://www.budgetprepay.com/MVNO/Verizon}batchSummaryType" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="attributes" type="{http://www.budgetprepay.com/MVNO/Verizon}groupAttributesType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "SearchPINGroupResponse", propOrder = {
    "returnMessage",
    "transactionContext",
    "batchSummary",
    "attributes"
})
public class SearchPINGroupResponse {

    @XmlElement(required = true)
    protected ReturnMessageType returnMessage;
    protected TransactionContextType transactionContext;
    protected List<BatchSummaryType> batchSummary;
    protected List<GroupAttributesType> attributes;
     ...
     * This is why there is not a <CODE>set</CODE> method for the batchSummary property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getBatchSummary().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link BatchSummaryType }
     * 
     * 
     */
    public List<BatchSummaryType> getBatchSummary() {
        if (batchSummary == null) {
            batchSummary = new ArrayList<BatchSummaryType>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link GroupAttributesType }
     * 
     * 
     */
    public List<GroupAttributesType> getAttributes() {
        if (attributes == null) {
            attributes = new ArrayList<GroupAttributesType>();
        }
