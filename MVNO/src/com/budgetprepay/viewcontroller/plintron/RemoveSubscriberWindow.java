...
public class RemoveSubscriberWindow extends Window implements AfterCompose {
	...
	public void validate() throws WrongValuesException {			
		...
		try { 
			...
			exs.add(new WrongValueException(mdn, ELFunctions.getMessage(Messages.IMSI_CANNOT_BE_EMPTY)));
		}
