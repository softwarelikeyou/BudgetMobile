...
public class ModifyLanguageWindow extends Window implements AfterCompose {
	...
	public String getNewLanaguage() {
		return newLanguage.getValue();
	}
	...
	public void validate() throws WrongValuesException {			
		...
		try { 
			newLanguage.getValue();
			newLanguage.getValue().isEmpty();
		}
		catch(WrongValueException ex) { 
			exs.add(new WrongValueException(newLanguage, ELFunctions.getMessage(Messages.LANGUAGE_CANNOT_BE_EMPTY)));
		}
