...
import com.budgetprepay.viewcontroller.component.ErrorMessageWindow;
import com.budgetprepay.viewcontroller.exception.LocalizedException;
...
public class WebUtil {
	...
	public static void showErrorBox(boolean suspendExecution, String msgKey, Object... varargs) {
		showErrorBox(suspendExecution, null, msgKey, varargs);
	}

	public static void showErrorBox(Throwable ex, String msgKey, Object... varargs) {
	...
	public static void showErrorBox(boolean suspendExecution, Throwable ex, String msgKey, Object... varargs) {
		...
		if( suspendExecution ) {
			try {
				...
				logger.error(e, Messages.COULD_NOT_SUSPEND_EXECUTION_TO_DISPLAY_ERROR_BOX);
			}
			catch( InterruptedException e ) {
				logger.error(e, Messages.RECEIVED_INTERRUPT_WHILE_SUSPENDED_DISPLAYING_AN_ERROR);
			}
		}
		else {
