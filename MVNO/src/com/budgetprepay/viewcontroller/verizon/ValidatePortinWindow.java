...
public class ValidatePortinWindow extends Window implements AfterCompose {
	...
	public void validate() throws WrongValuesException { 
		...
		try { 
			...
			exs.add(new WrongValueException(mdn, ELFunctions.getMessage(Messages.DEVICE_ID_CANNOT_BE_EMPTY)));
		}
